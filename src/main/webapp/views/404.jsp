	...
	<body id="page-top">
		...
		<div id="wrapper">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				<!-- Sidebar - Brand -->
				<a class="sidebar-brand d-flex align-items-center justify-content-center" href="views/index.jsp">
				...
				<div id="content">
					...
					<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
						...
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown no-arrow">
								...
								<img class="img-profile rounded-circle" src="assets/img/ProfilePhoto.png">
								</a>
					...
					<div class="container-fluid">
						...
						<div class="text-center">
							...
							<a href="views/index.jsp">&larr; Voltar para Produtos</a>
						</div>
					</div>
					<!-- /.container-fluid -->
				</div>
