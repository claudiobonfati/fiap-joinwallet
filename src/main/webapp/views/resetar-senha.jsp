								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											...
											<p class="mb-4">Basta digitar seu endereço de e-mail abaixo e enviaremos um link para redefinir sua senha!</p>
										</div>
										<form class="user">
										...
										<hr>
										<div class="text-center">
											<a class="small" href="cadastrar.jsp">Crie uma conta!</a>
										</div>
										<div class="text-center">
											<a class="small" href="login.jsp">Já é cadastrado? Faça o login!</a>
										</div>
									</div>
								</div>
							</div>
